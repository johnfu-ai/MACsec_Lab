...
# IEEE 802.1AE cipher suite IDs (8 octets, 802.1AE-2018 Table 9-1/Annex)
CS_GCM_AES_128 = bytes.fromhex("0080c20001000001")  # default (802.1AE-2006)
...
# Same 54-byte integrity frame, 256-bit key (Randall 2.1.2)
IEEE_INT_ICV_256 = _h("2F0BC5AF409E06D609EA8B7D0FA5EA50")

# Same 60-byte confidentiality frame, 256-bit key (Randall 2.2.2)
IEEE_ENC_CT_256 = _h(
    "E2006EB42F5277022D9B19925BC419D7"
    "A592666C925FE2EF718EB4E308EFEAA7"
    "C5273B394118860A5BE2A97F56AB7836"
)
IEEE_ENC_ICV_256 = _h("5CA597CDBB3EDB8D1A1151EA0AF7B436")
