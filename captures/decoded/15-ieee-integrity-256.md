# 逐帧解析 — `macsec-ieee-gcm-aes-256-integrity.pcap`
...
| # | 长度 | SA → DA | 一句话 |
|---:|---:|---|---|
| 1 | 86 | `7a:0d:46:df:99:8d` → `d6:09:b1:f0:56:63` | IEEE GCM-AES-256 integrity-only test vector (Randall 2.1.2) |

## 帧 1 — IEEE GCM-AES-256 integrity-only test vector (Randall 2.1.2)

**MACsec  PN=2999092325  integrity-only  SC=1  ICV=OK**

- 方向：`7a:0d:46:df:99:8d` → `d6:09:b1:f0:56:63`（86 B）
- 作用：IEEE GCM-AES-256 integrity-only test vector (Randall 2.1.2)
...
0040  31 32 33 34 00 01 2f 0b  c5 af 40 9e 06 d6 09 ea  1234../...@.....
0050  8b 7d 0f a5 ea 50                                 .}...P
```
